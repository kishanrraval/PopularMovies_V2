...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String title, releaseDate, poster, vote, synopsis, ID;
                ...
                try {
                    ...
                    ID = mvi_JSON.getString(API_ID);
                    intent.putExtra(API_ID, ID);
    ...
    class FetchMovies extends AsyncTask<String, Void, Movie[]>
    {
        ...
        private Movie[] getJSONMovieData(String JSONString) throws JSONException{
            ...
            Movie[] movieList = new Movie[mviArray.length()];
        ...
        protected Movie[] doInBackground(String... params)
        {
            ...
            {
                String query = "SELECT * FROM " + FavouritesContract.Favourites.TABLE_NAME;
                ...
                while (!c.isAfterLast()) {
                    ...
                    try {
                        movies.put(API_ID, c.getString(c.getColumnIndex(FavouritesContract.Favourites.COLUMN_NAME_ID)));
                        movies.put(API_POSTER, c.getString(c.getColumnIndex(FavouritesContract.Favourites.COLUMN_NAME_POSTER)));
                        movies.put(API_RELEASE, c.getString(c.getColumnIndex(FavouritesContract.Favourites.COLUMN_NAME_RELEASE)));
                        movies.put(API_TITLE, c.getString(c.getColumnIndex(FavouritesContract.Favourites.COLUMN_NAME_TITLE)));
                        movies.put(API_VOTE, c.getString(c.getColumnIndex(FavouritesContract.Favourites.COLUMN_NAME_VOTE)));
                        movies.put(API_SYNOPSIS, c.getString(c.getColumnIndex(FavouritesContract.Favourites.COLUMN_NAME_SYNOPSIS)));

                        c.moveToNext();

                        MoviesArray.put(i, movies);
                        i++;
                ...
                JSONObject mviFavouriteJSON = new JSONObject();
                try {
                    JSONArray_mvi = new JSONArray(MoviesArray.toString());
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                try {
                    mviFavouriteJSON.put("results", MoviesArray);
                } catch (JSONException e) {
                    e.printStackTrace();
                }

                try {
                    return getJSONMovieData(mviFavouriteJSON.toString());
                } catch (JSONException e) {
                    e.printStackTrace();
                }
